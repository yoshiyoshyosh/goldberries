...
(
 ...
 date_awarded timestamptz NOT NULL DEFAULT CURRENT_TIMESTAMP,
 position     integer NULL,
 CONSTRAINT badge_player_pkey PRIMARY KEY ( "id" ),
 CONSTRAINT badge_player_unique UNIQUE ( badge_id, player_id ),
 CONSTRAINT badge_player_player_id_fkey FOREIGN KEY ( player_id ) REFERENCES player ( "id" ) ON DELETE CASCADE ON UPDATE CASCADE,
 CONSTRAINT badge_player_badge_id_fkey FOREIGN KEY ( badge_id ) REFERENCES badge ( "id" ) ON DELETE CASCADE ON UPDATE CASCADE
);
